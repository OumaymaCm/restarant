...
<body class="flex flex-col min-h-screen">
    ...
    <footer class="bg-gray-50 border-t border-gray-200 mt-6">
        <div class="container flex flex-wrap items-center justify-center px-4 py-9 mx-auto lg:justify-between">
